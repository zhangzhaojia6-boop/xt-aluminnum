...
| --- | --- | --- | --- | --- | --- | --- |
| 01 | 系统总览主视图 | 审阅端 | `/review/overview` | 今日产量、订单达成、成品率、运行产线、异常、补录、交付 | 进入各中心、查看风险摘要 | Hero + KPI + 产线图 + 快捷入口 |
...
| 07 | 异常与补录 | 审阅端 | `/review/tasks` | 缺报、退回、差异、同步滞后、来源、风险等级 | 查看、补录、定位明细 | 异常表不是审核按钮集合 |
...
- 路由：`/review/overview`、`/review/factory`、`/review/workshop`、`/review/tasks`、`/review/reports`、`/review/quality`、`/review/reconciliation`、`/review/cost-accounting`、`/manage/ai-assistant`。
