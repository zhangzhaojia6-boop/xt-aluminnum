...
- [ ] **Step 1: Write the failing audit guard**
...
- [ ] **Step 2: Remove pending B21**

Delete the B21 row from "待处理问题清单".

- [ ] **Step 3: Re-run the audit guard**
...
- [ ] **Step 2: Run cross-layer static contracts used by recent audit work**
