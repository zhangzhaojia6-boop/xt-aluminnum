...
Execution note: `python -m pytest backend/tests -q --durations=10` returned `712 passed, 124 deselected, 31 warnings`; `git diff --check` passed with only Windows CRLF warnings.
