...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: '通讯通道', shortLabel: '通道', path: '/manage/channels', icon: Connection, access: 'admin', commandGroup: '系统' },
      { title: '知识库资料', shortLabel: '知识库', path: '/manage/rag', icon: DataLine, access: 'admin', commandGroup: '系统' },
