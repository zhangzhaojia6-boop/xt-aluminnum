...
.xt-status--neutral { color: var(--xt-gray-600); background: var(--xt-gray-100); }
.xt-status--primary { color: var(--xt-primary); background: var(--xt-primary-light); }
.xt-status--success { color: var(--xt-success); background: var(--xt-success-light); }
.xt-status--warning { color: var(--xt-warning); background: var(--xt-warning-light); }
.xt-status--danger { color: var(--xt-danger); background: var(--xt-danger-light); }
.xt-status--info { color: var(--xt-info); background: var(--xt-info-light); }
</style>
