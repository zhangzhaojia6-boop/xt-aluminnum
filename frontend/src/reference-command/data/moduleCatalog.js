export const referenceModules = Object.freeze([
  ...
  },
  {
    ...
    title: '成本核算与效益中心',
    surface: 'review',
    routeName: 'cost-accounting-center',
  ...
  },
  {
    ...
    title: '主数据与模板中心',
    surface: 'admin',
    routeName: 'workshop-template-config',
  ...
  },
  {
    ...
    title: '响应式录入体验',
    surface: 'entry',
    routeName: 'responsive-entry-experience',
    routePath: '/entry',
  ...
  },
  {
    ...
    title: '路线图与下一步',
    surface: 'review',
    routeName: 'review-roadmap-center',
    routePath: '/review/roadmap',
    layout: 'roadmap',
    kpiKeys: ['current', 'mid', 'long', 'progress'],
    primary: { type: 'roadmap', source: 'roadmap' },
    side: { type: 'nextActions', source: 'roadmap' },
    actions: ['openAdminRoadmap'],
    alternateRouteNames: ['admin-roadmap-center'],
    alternateRoutePaths: ['/admin/roadmap']
  }
])
