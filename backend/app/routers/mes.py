...
def sync_status(
    ...
    return MesSyncStatusOut(
        ...
        sync_lag_seconds=sync_payload.get('sync_lag_seconds'),
        sync_freshness_seconds=sync_payload.get('sync_freshness_seconds'),
        source_lag_seconds=sync_payload.get('source_lag_seconds'),
        ...
        adapter=sync_payload.get('adapter') or 'null',
        source=sync_payload.get('source') or 'local_entry',
        stale_threshold_seconds=sync_payload.get('stale_threshold_seconds'),
        retry_limit=int(sync_payload.get('retry_limit') or 0),
