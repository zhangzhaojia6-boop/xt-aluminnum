...
def _projection_fields(snapshot: CoilSnapshot, synced_at: datetime) -> dict[str, Any]:
    ...
    return {
        ...
        'customer_alias': _to_text(_metadata_value(metadata, 'CustomerAlias', 'CustomerSimple', 'CustomerName', 'Customer', 'customer_alias')),
        ...
        'material_weight': _to_float(_metadata_value(metadata, 'MaterialWeight', 'Weight')),
        'gross_weight': _to_float(_metadata_value(metadata, 'GrossWeight')),
        'net_weight': _to_float(_metadata_value(metadata, 'NetWeight', 'InStockNetWeight')),
        ...
        'status_name': _to_text(_metadata_value(metadata, 'StatusName', 'Status', 'status_name')),
        'card_status_name': _to_text(_metadata_value(metadata, 'CardStatusName', 'CardStatus', 'card_status_name')),
        'production_status': _to_text(_metadata_value(metadata, 'ProductionStatus', 'PrintStatus', 'production_status')),
