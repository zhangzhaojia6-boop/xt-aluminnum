...
DAILY_PRODUCTION_MAPPING_RULES: dict[tuple[str, str], MappingRule] = {
    ...
    ('铸轧', '铸五'): MappingRule(workshop_code='ZR5'),
    ('铸轧', '铸六'): MappingRule(workshop_code='ZR6'),
    ...
    ('热轧', '中厚板'): MappingRule(workshop_code='RZ', equipment_code='RZ-ZJ', equipment_required=True),
    ...
    ('老厂', '拉矫'): MappingRule(workshop_code='JZ', equipment_code='JZ-LWJ1', equipment_required=True),
    ('老厂', '剪子'): MappingRule(workshop_code='JZ', equipment_code='JZ-HJ1', equipment_required=True),
    ...
    ('锅炉', '拉矫'): MappingRule(workshop_code='JZ'),
    ('回收', ''): MappingRule(workshop_code='HS'),
