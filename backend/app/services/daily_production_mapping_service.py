...
DAILY_PRODUCTION_MAPPING_RULES: dict[tuple[str, str], MappingRule] = {
    ...
    ('在线退火', '新厂南'): MappingRule(workshop_code='ZXTF', equipment_code='ZXTF-2', equipment_required=True),
    ('在线退火', '新厂北'): MappingRule(workshop_code='ZXTF', equipment_code='ZXTF-1', equipment_required=True),
    ('在线退火', '园区北'): MappingRule(workshop_code='ZXTF', equipment_code='ZXTF-3', equipment_required=True),
    ('在线退火', '园区南'): MappingRule(workshop_code='ZXTF', equipment_code='ZXTF-4', equipment_required=True),
    ...
    ('在线退火', '园区南线'): MappingRule(workshop_code='ZXTF', equipment_code='ZXTF-4', equipment_required=True),
