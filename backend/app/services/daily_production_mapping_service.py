...
DAILY_PRODUCTION_MAPPING_RULES: dict[tuple[str, str], MappingRule] = {
    ...
    ('热轧', '六面铣'): MappingRule(workshop_code='RZ', equipment_code='RZ-FM', equipment_required=True),
    ('热轧', '双面铣'): MappingRule(workshop_code='RZ', equipment_code='RZ-DM', equipment_required=True),
    ('热轧', '加热炉'): MappingRule(workshop_code='RZ', equipment_code='RZ-HE', equipment_required=True),
    ...
    ('精整', '19辊'): MappingRule(workshop_code='JZ', equipment_code='JZ-19G', equipment_required=True),
    ...
    ('拉矫', '大分切'): MappingRule(workshop_code='LJ', equipment_code='LJ-DFC', equipment_required=True),
    ('拉矫', '分切'): MappingRule(workshop_code='LJ', equipment_code='LJ-DFC', equipment_required=True),
    ('拉矫', '小剪子'): MappingRule(workshop_code='LJ', equipment_code='LJ-XJZ', equipment_required=True),
    ('拉矫', '产量'): MappingRule(workshop_code='LJ'),
    ('退火炉', '拉矫'): MappingRule(workshop_code='LJ', equipment_code='JQ-TH', equipment_required=True),
    ('退火炉', '2050'): MappingRule(workshop_code='LZ2050'),
    ('在线退火', '新厂南'): MappingRule(workshop_code='ZXTF-N', equipment_code='ZXTF-2', equipment_required=True),
    ('在线退火', '新厂北'): MappingRule(workshop_code='ZXTF-N', equipment_code='ZXTF-1', equipment_required=True),
    ('在线退火', '园区北'): MappingRule(workshop_code='ZXTF-P', equipment_code='ZXTF-3', equipment_required=True),
    ('在线退火', '园区南'): MappingRule(workshop_code='ZXTF-P', equipment_code='ZXTF-4', equipment_required=True),
    ('在线退火', '新厂南线'): MappingRule(workshop_code='ZXTF-N', equipment_code='ZXTF-2', equipment_required=True),
    ('在线退火', '新厂北线'): MappingRule(workshop_code='ZXTF-N', equipment_code='ZXTF-1', equipment_required=True),
    ('在线退火', '园区北线'): MappingRule(workshop_code='ZXTF-P', equipment_code='ZXTF-3', equipment_required=True),
    ('在线退火', '园区南线'): MappingRule(workshop_code='ZXTF-P', equipment_code='ZXTF-4', equipment_required=True),
    ('在线退火', '南线'): MappingRule(workshop_code='ZXTF-N'),
    ('淬火', '淬火'): MappingRule(workshop_code='CH', equipment_code='CH-CHX', equipment_required=True),
    ('淬火', '矫直'): MappingRule(workshop_code='CH', equipment_code='CH-JZ1', equipment_required=True),
    ('淬火', '抛光'): MappingRule(workshop_code='CH', equipment_code='CH-PG1', equipment_required=True),
    ('淬火', '锯切'): MappingRule(workshop_code='CH', equipment_code='CH-JQ', equipment_required=True),
    ('淬火', '拉伸'): MappingRule(workshop_code='CH', equipment_code='CH-LS', equipment_required=True),
    ('剪切', '1#'): MappingRule(workshop_code='JQ', equipment_code='JQ-1', equipment_required=True),
    ('剪切', '2#'): MappingRule(workshop_code='JQ', equipment_code='JQ-2', equipment_required=True),
    ('剪切', '3#'): MappingRule(workshop_code='JQ', equipment_code='JQ-3', equipment_required=True),
    ...
    ('双面铣', ''): MappingRule(workshop_code='RZ', equipment_code='RZ-DM', equipment_required=True),
    ('加热炉', ''): MappingRule(workshop_code='RZ', equipment_code='RZ-HE', equipment_required=True),
}
