...
def parse_output_skill_daily_report(text: str) -> dict[str, Any]:
    ...
    energy_patterns = {
        ...
        "cast_roll_gas_per_ton_daily": rf"铸轧分厂.*?日吨气耗{_NUMBER}m³",
        "cast_roll_gas_per_ton_month": rf"铸轧分厂.*?月吨气耗{_NUMBER}m³",
        "foundry_electricity_per_ton_daily": rf"铸锭车间日吨电耗{_NUMBER}度",
        "foundry_electricity_per_ton_month": rf"铸锭车间日吨电耗.*?月吨电耗{_NUMBER}度",
        "foundry_gas_per_ton_daily": rf"铸锭车间.*?日吨气耗{_NUMBER}m³",
        "foundry_gas_per_ton_month": rf"铸锭车间.*?月吨气耗{_NUMBER}m³",
        "hot_roll_electricity_per_ton_daily": rf"热轧车间日吨电耗{_NUMBER}度",
        "hot_roll_electricity_per_ton_month": rf"热轧车间日吨电耗.*?月吨电耗{_NUMBER}度",
        "hot_roll_gas_per_ton_daily": rf"热轧车间.*?日吨气耗{_NUMBER}m³",
        "hot_roll_gas_per_ton_month": rf"热轧车间.*?月吨气耗{_NUMBER}m³",
