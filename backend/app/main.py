...
app.include_router(agent.router, prefix=f'{settings.API_V1_PREFIX}/agent')
...
app.include_router(hermes_data_audit.router, prefix=f'{settings.API_V1_PREFIX}/hermes/data-audit')
