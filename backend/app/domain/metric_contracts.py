...
CORE_METRIC_CONTRACTS: dict[str, dict[str, Any]] = {
    'factory_total_output_tons': {
        ...
        'fallback_source': 'daily_consumable_logs.payload.packaging_inbound_output_tons then owner_daily.storage_inbound_weight then mobile_shift_reports.storage_finished',
        'business_date_basis': 'production_business_date',
        'aggregation_rule': 'sum_mes_final_packaging_output_first',
