...
CORE_METRIC_CONTRACTS: dict[str, dict[str, Any]] = {
    'factory_total_output_tons': {
        ...
        'label': '全厂总产量',
        'unit': 't',
        'primary_source': 'daily_consumable_logs.payload.packaging_inbound_output_tons',
        'fallback_source': 'owner_daily.storage_inbound_weight then mobile_shift_reports.storage_finished',
        'business_date_basis': 'owner_daily_business_date',
        'aggregation_rule': 'sum_final_packaging_inbound_only',
