...
class HermesDingTalkSamplingRule(Base):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True)
    rule_key: Mapped[str] = mapped_column(String(128), nullable=False, unique=True, index=True)
    channel_key: Mapped[str] = mapped_column(String(128), nullable=False, index=True)
    specialist_user_id: Mapped[str] = mapped_column(String(64), nullable=False, index=True)
...
class HermesKnowledgeUnit(Base):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True)
    unit_key: Mapped[str] = mapped_column(String(128), nullable=False, unique=True, index=True)
